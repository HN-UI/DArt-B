...
```
<img width="999" alt="스크린샷 2024-10-01 18 17 10" src="https://github.com/user-attachments/assets/8a921199-d407-4db7-8a56-f46c95e61529">

```
배송 날짜가 21년, 22년에 해당되는 데이터를 필터링 하는 것이 우선시 되어야 하기 때문에 이를 상위 필터로 설정하고자
년(배송 날짜) 필터를 컨텍스트 필터로 설정하여 해당 년도들의 매출 상위 10개 도시들을 나타내었다.
```
